	...
	MENUITEMS: Menu[] = [
		{
			title: 'Dashboard', icon: 'folder-plus', type: 'sub', badgeType: 'primary', badgeValue: 'new documents', active: false, children: [
				...
				{
					path: '/dashboard/quarterone', title: 'K1 2020', icon: 'file', type: 'link'
		
				},
				{
					path: '/dashboard/quarterone', title: 'Distribution Letters', icon: 'file', type: 'link'
		
				},
					{
					path: '/dashboard/quarterone', title: 'Capital Call', icon: 'file', type: 'link'
